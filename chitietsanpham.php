...
<div class="col-md-12">
    <div>
        <ol class="breadcrumb">
            <li><a
                    href="<?php echo $sp->hrefdanhsachsanpham('dsSP', '', $_GET['hang'], $_GET['sx'], $_GET['page'], $_GET['key']); ?>">Trang
                    chủ</a>
            </li>
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <!---show chi tiet san pham--->
            ...
            <div class="caption">
                ...
                <p>Giá : <strong><?php echo $rowSP['price_product']; ?> Vnd</strong> </p>
                <?php else: ?>
                <p style="color: red;">Chỉ còn : <strong><?php echo $rowSP['sale_product']; ?> Vnd</strong> </p>
                <?php endif; ?>
