...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `user_account` varchar(50) COLLATE utf32_unicode_ci NOT NULL ,
...
insert into `accounts`(`user_account`,`email_account`,`pass_account`,`phone_account`,`address_account`,`balance_account`) values
('hoang','nguyenthaihoang@gmail.com','123','123456789','da nang','123');
-- --------------------------------------------------------
...
-- --------------------------------------------------------
insert into carts(id_cart,user_account,date_cart)
value(null,'hoang',now());
--
...
ALTER TABLE carts
 ADD CONSTRAINT fk_acco
   FOREIGN KEY (user_account)
   REFERENCES accounts (user_account);
